...
local CONFIG = {
    ...
    PC = {
        label = "PC",
        scriptUrls = {
                "https://raw.githubusercontent.com/quarter67/testing/refs/heads/main/test.lua",
            },
        keylessUrls = {
                "https://raw.githubusercontent.com/quarter67/testing/refs/heads/main/test.lua",
            },
        localPaths = {
                ...
                "workspace/test.lua",
                "nightfall/test.lua",
                "Downloads/script/test.lua",
            },
        keylessLocalPaths = {
                "testkeyless.lua",
                "script/testkeyless.lua",
                "ScriptHub/testkeyless.lua",
                "workspace/testkeyless.lua",
                "nightfall/testkeyless.lua",
                "Downloads/script/testkeyless.lua",
            },
        premiumMarker = "test",
        keylessMarker = "testkeyless",
        premiumName = "test",
        keylessName = "testkeyless",
    },
    MOBILE = {
        label = "Mobile",
        scriptUrls = {
