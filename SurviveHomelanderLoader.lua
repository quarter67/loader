--[[
    NightFall Unified Loader — auto-detects PC vs mobile

    GitHub: quarter67/loader (SurviveHomelanderLoader.lua)
    Scripts: quarter67/NightFall

    loadstring(game:HttpGet("https://raw.githubusercontent.com/quarter67/loader/main/SurviveHomelanderLoader.lua?t=" .. os.time()))()
]]

local VERSION = "1.0.0-unified"
...
pcall(function()
    local old = pg:FindFirstChild("NightFallLoaderUI")
    if old then old:Destroy() end
    old = pg:FindFirstChild("NightFallPCKeyUI")
    if old then old:Destroy() end
end)

local gui = Instance.new("ScreenGui")
gui.Name = "NightFallLoaderUI"
...
subtitle.Text = PLATFORM.label .. " detected · premium or keyless build auto-selected"
...
keylessBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        if ok then
            pcall(function() gui:Destroy() end)
            print("[NightFall] Keyless load complete (" .. PLATFORM.label .. ", premium locked).")
            return
        end
